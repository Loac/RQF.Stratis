/*
    ...
    Description:
        Переместить игрока на заданное расстояние вперед.
        Функция нужна для отладки.

    Example:
        _null = [10] execVM "rqf\functions\fnc_jumpForward.sqf";
 */
...
if (count _isFlat == 0) then {
    player sideChat "Bad place";
}
else {
    player sideChat "Good place";
}
